...
public class MySQL {
	...
	public void saveData(TransactionSet transactionSet, RuleSet ruleSets) {
	...
	public void saveRules(RuleSet associationRuleSet, int ts_id) {
		...
		try {
			...
			for(Rule rule : associationRuleSet.getRules()) {
